              ...
              .then((url) => {
                db.collection("updateReview")
                  ...
                  .then(function (docRef) {
                    ...
                    db.collection("users")
                      .doc(id)
                      .update({ updateReviewStartupId: arrayUnion(idd) });
                    db.collection("startups")
                      .doc(idd)
                      .update({ updateReviewId: docRef.id });
      ...
      <form onKeyDown={onKeyDown} onSubmit={(e) => submitProdReview(e)}>
        ...
        >
          ...
          <Text
            ...
            fontWeight={900}
          >
            ⚠️ Warning: Overposting/spamming will result in a ban and removal of
            all posts.
          </Text>
          {/* <Flex>
            <Button
...
export default UpdateReviewReg;
